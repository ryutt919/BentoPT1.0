...
def main():
    ...
    cfg = Config.fromfile('mmaction2/work_dirs/custom_stgcnpp/custom_stgcnpp.py')
    
    # Initialize label encoder with all possible labels
    label_encoder = LabelEncoder()
    all_labels = ['unlabeled', 'outlier', 'good', 'elbow_not_vertical', 'hand_position_bad',
    ...
    checkpoint_path = 'mmaction2/work_dirs/custom_stgcnpp/best_acc_top1_epoch_35.pth'
    ...
    unlabeled_dataset = UnlabeledDataset('data/pkl/unlabeled.pkl')
    ...
    # Update training dataset with pseudo-labels
    update_dataset_with_pseudo_labels('data/pkl/train.pkl', predictions, label_encoder)
